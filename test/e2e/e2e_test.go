...
import (
	...
	"github.com/vicentinileonardo/cloud-resource-manager/test/utils"
)

// namespace where the project is deployed in
const namespace = "operator-cloud-resource-manager-system"

// serviceAccountName created for the project
const serviceAccountName = "operator-cloud-resource-manager-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "operator-cloud-resource-manager-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "operator-cloud-resource-manager-metrics-binding"
	...
	Context("Manager", func() {
		...
		It("should ensure the metrics endpoint is serving metrics", func() {
			...
			cmd := exec.Command("kubectl", "create", "clusterrolebinding", metricsRoleBindingName,
				"--clusterrole=operator-cloud-resource-manager-metrics-reader",
