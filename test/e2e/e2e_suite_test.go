...
var (
	...
	projectImage = "example.com/operator-cloud-resource-manager:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting operator-cloud-resource-manager integration test suite\n")
